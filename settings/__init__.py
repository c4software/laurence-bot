...
REDDIT_IMAGE = ["Cinemagraphs", "bridgeporn", "spaceporn", "AuroraPorn", "SkyPorn", "ExposurePorn", "Photobomb",
                "photoshopfail", "ITookAPicture", "photoshopbattles", "pic", "pics", "EarthPorn"]
REDDIT_LOL = ["funny", "lolcats", "cats", "pets", "CatGifs", "lolcats", "aww"]
REDDIT_GIF = ["gifs", "CatGifs", "perfectLoops", "SurrealGifs", "SpaceGifs", "aww"]
REDDIT_OTHER = ["Futurology", "Nostalgia", "ads", "france", "CollegeCooking", "EarthPorn", "history", "videos",
                "worldnews", "random", "random", "random"]
