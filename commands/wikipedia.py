...
def cmd_aide(msg):
    ...
    try:
        ...
        if query:
            ...
            retour = callrest(domain=domain, port="443", ssl=True, params=params, path="/w/api.php",
                              user_headers={"Accept-Charset": "utf-8"})
        ...
        if msg["query"]:
            return "Aucun résultat pour {0}".format(msg["query"])
